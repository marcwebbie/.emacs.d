...
(define-key pelican-keymap (kbd "C-c b n")
  'pelican-insert-header)
(define-key pelican-keymap (kbd "C-c b p")
  'pelican-publish-draft)
(define-key pelican-keymap (kbd "C-c b t")
  'pelican-update-date)
(define-key pelican-keymap (kbd "C-c b h")
  'pelican-make-html)
(define-key pelican-keymap (kbd "C-c b u")
